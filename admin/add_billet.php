        ...
        <div class="row">
            <div class="col-lg-8 col-md-10 mx-auto">
                <div class="site-heading">
                    <h1>Mon blog!</h1>
                    <span class="subheading">Les 5 derniers billets :</span>
                    </br>
                    <form action="/admin/add_billet.php" method="POST" >
    ...
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            ...
            while($donnees = $billets->fetch())
            {
                ...
                echo '<br/><br/><a href="http://tomus.ovh/space/follow/admin/modif_billet.php?id=' . htmlspecialchars($donnees['id']) . '">Modifier le billet </a>';

                echo '<br/><br/><a href="http://tomus.ovh/space/follow/c/admin/bdd_billet.php?id=' . htmlspecialchars($donnees['id']) . '&action=supprimer">Supprimer le billet </a></p>';
