    ...
    <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
            ...
            include("Repeat/connection_BDD.php");
                ...
                ?>
                <div><h4> Ajouter un billet</h4>
                    <form method="post" action="bdd_billet.php">
                        <input type="text" name="titre" placeholder="Ajouter le titre "><br/><br/>
                        <textarea name="contenu" rows="5" cols="20" placeholder="Ajouter le contenu"></textarea><br/>
