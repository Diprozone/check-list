        ...
        <div class="site-heading">
          ...
          <span class="subheading">Les 5 derniers billets :</span>
            ...
            <form action="add_billet.php" method="POST" >
                <input type="submit" value="Gérer les billets" class="btn btn-secondary"/>
            </form>
        </div>
      </div>
    </div>
...
$billets = $bdd->query('SELECT id,titre,contenu,DATE_FORMAT(date_creation, \' le %d/%m/%Y à %Hh%imin%ss\') AS date_creation FROM billets GROUP BY id DESC LIMIT 0,5');
      ...
      echo '<br/><br/><a href="http://tomus.ovh/space/follow/comentaires.php?id=' . htmlspecialchars($donnees['id']) . '">Afficher les commentaires </a></p>';
